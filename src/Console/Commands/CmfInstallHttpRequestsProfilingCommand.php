...
class CmfInstallHttpRequestsProfilingCommand extends CmfCommand
{
    ...
    public function handle(): int
    {
        ...
        $this->line(
            'Note: In order to profile all sql queries you may need to place middleware 1st in the list'
            . ' or call PeskyOrmPdoProfiler::init() in AppServiceProvider->register().'
        );
        $this->line(
            'Review middleware class to find out what arguments it accepts for custom configuration of profiling'
        );
        return 0;
    }
}
