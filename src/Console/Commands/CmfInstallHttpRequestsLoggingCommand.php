...
class CmfInstallHttpRequestsLoggingCommand  extends CmfCommand {
    ...
    public function handle() {
        ...
        $this->line('3. Add "' . CmfHttpRequestLogsScaffoldConfig::class . '" to "resources" key in your cmf config (by default: config/peskycmf.php).');
        $this->line('Review middleware class to find out what arguments it accepts for custom configuration of logging');
    }
