...
class CmfAdminsTable extends BaseCommand {
    ...
    protected $signature = 'cmf:admins_table';
    ...
    public function fire() {
        ...
        File::load($folder->pwd() . '/' . date('Y_m_d_His', time()) . '_create_admins_table.php', true, 0755, 0644)
            ->write(view('cmf::install.db.create_admins_table_migration')->render());
        $this->line('Done');
