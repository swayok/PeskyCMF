...
<ul class="sidebar-menu" data-widget="tree" id="common-menu-header">
    <li class="header">{{ $cmfConfig->transCustom('main_menu.header') }}</li>
</ul>
                    ...
                    <ul class="treeview-menu" @if(!empty($info['open'])) style="display: block" @endif>
                        ...
                        <li>
                            ...
                            >
                                ...
                                <span>{!! trans($subItem['label']) !!}</span>{!! \Illuminate\Support\Arr::get($subItem, 'addition', '') !!}
                ...
                <li>
                    ...
                    >
                        @if (!empty($info['icon']))
                            <i class="{{ $info['icon'] }}"></i>
                        @endif
                        <span>{!! trans($info['label']) !!}</span>{!! \Illuminate\Support\Arr::get($info, 'addition', '') !!}
