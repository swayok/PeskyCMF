...
class CmfScaffoldApiController extends Controller {
    ...
    public function getItemDefaults() {
        ...
        $data = $formConfig->alterDefaultValues($this->getTable()->newRecord()->getDefaults());
     ...
     */
    private function getConditionsForBulkActions(Request $request, CmfTable $model, $inputNamePrefix = '') {
     ...
     */
    protected function sendItemNotFoundResponse(CmfTable $model, $message = null) {
        if (empty($message)) {
