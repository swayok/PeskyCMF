...
class CmfInstall extends BaseCommand {
    ...
    public function fire() {
        ...
        $file = File::load($subfolder->pwd() . '/' . $lowercasedSubfolder . '.config.php', true, 0755, 0644);
        ...
        Folder::load($folder->pwd() . '/Http/Middleware', true, 0755);
        ...
        $file->write(view('cmf::install.db.admin_objcet')->render());
