...
<div class="login-box">
    <div class="login-logo">
        ...
        <b>{!! trans("{$dictionary}.replace_password_form.header") !!}</b>
    </div>
        ...
        <form action="{{ route('cmf_replace_password', [$accessKey], false) }}" method="post" id="replace-password-form">
            ...
            <div class="form-group has-feedback">
                <input type="password" name="password" required class="form-control"
                    placeholder="{{ trans("{$dictionary}.replace_password_form.password_label") }}">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" name="password_confirm" required class="form-control"
                    placeholder="{{ trans("{$dictionary}.replace_password_form.password_confirm_label") }}">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="login-submit text-right">
                <button type="submit" class="btn btn-primary btn-flat">
                    {{ trans("{$dictionary}.replace_password_form.button_label") }}
                </button>
            </div>
        </form>
    </div>
