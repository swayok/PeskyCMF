...
<input type="text" name="login" formnovalidate disabled style="<?php echo $hidingStyles ?>" >
<input type="text" name="name" formnovalidate disabled style="<?php echo $hidingStyles ?>" >
<input type="password" name="password" formnovalidate disabled style="<?php echo $hidingStyles ?>" >
