...
class CmsTextsForItemsScaffoldConfig extends NormalTableScaffoldConfig {
    ...
    protected function createFormConfig() {
        return parent::createFormConfig()
            ->setWidth(100)
            ->addTab(cmfTransCustom('.texts_for_items.form.tab.general'), [
            ...
            ->addTab(cmfTransCustom('.texts_for_items.form.tab.content'), [
                'comment',
    ...
    public function addSpecialValidators() {
        ...
        \Validator::replacer('unique_language_within_parent_id', function ($message, $attribute, $rule, $parameters) use ($textsTable) {
            return cmfTransCustom('.texts_for_items.form.validation.unique_language_within_parent_id', [
            ...
            WysiwygFormInput::createDataInsertConfigWithArguments(
                ...
                [
                    ...
                    'text_field' => [
                        ...
                        'type' => 'select',
                        'options' => [
                            'title' => cmfTransCustom('.texts_for_items.form.input.title'),
                            'content' => cmfTransCustom('.texts_for_items.form.input.content'),
                        ],
                        'value' => 'content'
                    ]
                ],
                cmfTransCustom('.texts_for_items.form.input.insert_other_text_widget_title_template')
            ),
        ];
    }
