...
return [
     ...
     */
    'base_table_class' => \PeskyCMF\CMS\CmsTable::class,
    'base_record_class' => \PeskyCMF\CMS\CmsRecord::class,
    'base_table_structure_class' => \PeskyCMF\CMS\CmsTableStructure::class,
