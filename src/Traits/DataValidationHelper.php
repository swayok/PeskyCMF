...
trait DataValidationHelper
{
    ...
    public function validate(
        ...
        $errors = $this->validateAndReturnErrors(
            $dataOrRequest,
            $rules,
            $messages,
            $customAttributes
     ...
     */
    protected function extractInputFromRules(
        array|Collection|Request $data,
        array $rules
    ): array {
    ...
    public function makeValidationErrorsJsonResponse(array $errors): JsonResponse
    {
        return new JsonResponse(
            $this->prepareDataForValidationErrorsResponse($errors),
            HttpCode::CANNOT_PROCESS
        );
    }
    ...
    public function prepareDataForValidationErrorsResponse(array $errors): array
    {
        $message = Arr::get(
            $errors,
            CmfJsonResponse::$messageKey,
            $this->getValidationErrorsResponseMessage()
        );
